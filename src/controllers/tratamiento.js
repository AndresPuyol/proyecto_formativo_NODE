...
export const actualizarTratamiento = async (req, res) => {
    try {
        ...
        const [result] = await Pool.query(sql, [descripcion, fecha_inicio, fecha_final, Tipo_Tratamiento, Id_Tratamiento]);
...
export const eliminarTratamiento = async (req, res) => {
    try {
        ...
        const [result] = await Pool.query(sql, [Id_Tratamiento]);
...
export const obtenerTratamiento = async (req, res) => {
    try {
        ...
        const [rows] = await Pool.query(sql, [Id_Tratamiento]);
